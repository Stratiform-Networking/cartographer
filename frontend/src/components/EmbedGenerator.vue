<template>
  <Teleport to="body">
    ...
    >
      <div
        class="bg-white dark:bg-slate-900 rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden max-h-[90vh] flex flex-col border border-slate-200/80 dark:border-slate-800/80"
      >
        <!-- Header -->
        <div
        ...
        <div class="p-4 overflow-auto flex-1">
          ...
          <template v-else>
            <!-- Readonly notice -->
            <div
              v-if="!canWrite && !selectedEmbed"
              class="mb-4 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/15 border border-amber-200/80 dark:border-amber-800/30"
            >
              ...
              <p class="text-xs text-amber-600 dark:text-amber-400 mt-1 ml-6">
            ...
            <div v-if="!selectedEmbed && canWrite" class="mb-4">
              ...
              <div
                v-if="showCreateForm"
                class="mt-3 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-700/50"
              >
                <div class="mb-3">
                ...
                <div class="flex items-center justify-between mb-3">
                  ...
                  >
                    <span
                      ...
                      :class="newEmbedSensitive ? 'translate-x-4' : ''"
                    ></span>
                  </button>
                </div>
                ...
                <div class="flex items-center justify-between mb-3">
                  ...
                  >
                    <span
                      class="absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform"
                      :class="newEmbedShowOwner ? 'translate-x-4' : ''"
                    ></span>
                  </button>
                </div>
                ...
                <div v-if="newEmbedShowOwner" class="mb-3 pl-6">
                  <label class="flex items-center gap-2 cursor-pointer mb-1">
                    <input
                      type="radio"
                      v-model="newEmbedOwnerType"
                      value="fullName"
                      class="text-cyan-600 focus:ring-cyan-500"
                    />
                    <span class="text-xs text-slate-600 dark:text-slate-400"
                      >Full Name ({{ currentUser?.first_name }} {{ currentUser?.last_name }})</span
                    >
                  </label>
                ...
                >
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <div
                        class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 flex items-center gap-2"
                      >
                        <span
                          v-if="embed.sensitiveMode"
            ...
            <div v-else>
              ...
              <div class="mb-3">
                ...
                <div class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                  ...
                  <span v-if="selectedEmbed.updatedAt !== selectedEmbed.createdAt">
                    • Updated {{ formatDate(selectedEmbed.updatedAt) }}</span
                  >
                </div>
              </div>
              ...
              <!-- Settings -->
              <div
                class="mb-3 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-700/50"
              >
                <div
                  class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2"
                >
              ...
              <div
                v-if="confirmDelete"
                class="mt-3 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200/80 dark:border-red-800/50"
              >
                <p class="text-xs text-red-800 dark:text-red-200 mb-3">
                  Are you sure you want to delete this embed? This action cannot be undone.
                </p>
                <div class="flex justify-end gap-2">
                  <button
