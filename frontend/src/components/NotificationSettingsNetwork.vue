        ...
        <div class="grid grid-cols-3 gap-3">
          <div>
            ...
            <p class="text-lg font-semibold text-slate-800 dark:text-slate-100">
              {{ anomalyStats.devices_tracked || 0 }}
            </p>
          </div>
          <div>
            <p class="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider">
            ...
            <p class="text-lg font-semibold text-slate-800 dark:text-slate-100">
              {{ anomalyStats.anomalies_detected_24h || 0 }}
            </p>
          </div>
          <div>
            <p class="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider">
            ...
            <p class="text-lg font-semibold text-slate-800 dark:text-slate-100">
              {{ anomalyStats.is_online_learning ? 'Online Learning' : 'Initializing' }}
            </p>
          </div>
        </div>
      </div>
...
function getTypePriority(type: string): string {
  ...
  return (
    priorities[type] ||
    networkNotificationTypes.find((t) => t.value === type)?.defaultPriority ||
    'medium'
  );
}
