<template>
  <div
    class="min-h-screen bg-gradient-to-br from-slate-100 via-slate-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center p-4 transition-colors"
  >
    <div class="w-full max-w-md">
      <!-- Logo/Header -->
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#0fb685] to-[#0994ae] rounded-2xl shadow-lg shadow-[#0fb685]/30 mb-4"
        >
          <svg
      ...
      <!-- Setup Card -->
      <div
        class="bg-white dark:bg-slate-800/50 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl shadow-xl dark:shadow-2xl p-8"
      >
        ...
        <form @submit.prevent="onSubmit" class="space-y-5">
          ...
          <div>
            ...
            <p class="mt-1 text-xs text-slate-400 dark:text-slate-500">Minimum 8 characters</p>
          </div>
          ...
          <div
            v-if="errorMessage"
            class="p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-500/50 rounded-lg"
          >
