    ...
    >
      ...
      >
        ...
        >
          <div
            v-if="isOpen"
            class="bg-white dark:bg-slate-900 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden border border-slate-200/80 dark:border-slate-800/80"
          >
            <!-- Header -->
            <div
                    ...
                    <div class="flex-1 min-w-0">
                      <div class="flex items-center gap-2 flex-wrap">
                        ...
                        >
                          ...
                          <template v-else> You're up to date! </template>
                        </p>
                        ...
                        <!-- Notifying spinner -->
                        <span
                          v-if="isSendingNotification && updateCheckResult.has_update"
                          class="text-[10px] text-cyan-600 dark:text-cyan-400 flex items-center gap-1"
                        >
                          <svg
                      ...
                      >
                        <template v-if="updateCheckResult.has_update">
                          <span class="font-medium">v{{ updateCheckResult.latest_version }}</span>
                          is available
            ...
            <!-- Footer -->
            <div
              class="px-4 py-3 border-t border-slate-200 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-950/50 flex justify-end"
            >
              <button
                @click="$emit('close')"
