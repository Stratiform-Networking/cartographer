									...
									<div class="flex items-start gap-4">
										...
										<div class="flex items-center gap-3">
											...
											<a
												...
												class="inline-flex items-center gap-1 px-2.5 py-1 bg-cyan-600 hover:bg-cyan-500 text-white text-xs font-medium rounded-lg transition-colors"
											>
											...
											<!-- Notifying spinner -->
											<span v-if="isSendingNotification && updateCheckResult.has_update" class="text-xs text-cyan-600 dark:text-cyan-400 flex items-center gap-1">
