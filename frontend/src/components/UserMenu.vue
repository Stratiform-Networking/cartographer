  ...
  <div class="relative" ref="menuContainer">
    ...
    >
      ...
      <div class="flex flex-col items-start">
        <span
          class="text-sm font-medium text-slate-700 dark:text-slate-200 max-w-24 truncate leading-tight"
        >
          {{ displayName }}
        </span>
        <!-- Role Badge -->
    ...
    <Teleport to="body">
      ...
      >
        <div
          ...
          class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 dark:bg-slate-950/90"
        >
          <Transition
            enter-active-class="transition ease-out duration-200"
          ...
          >
            <div
              v-if="showPasswordModal"
              class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-slate-200/80 dark:border-slate-700/50"
            >
              <!-- Header -->
              <div
                class="flex items-center justify-between px-6 py-4 bg-slate-50 dark:bg-slate-950/50 border-b border-slate-200/80 dark:border-slate-700/50"
              >
                <div class="flex items-center gap-3">
                  <div
                    class="w-9 h-9 rounded-lg bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <form @submit.prevent="onSubmitPassword" class="p-6 space-y-4">
                ...
                >
                  <div
                    v-if="passwordError"
                    class="p-3 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/30 rounded-lg"
                  >
