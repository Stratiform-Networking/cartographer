...
const createMockedEmbedGenerator = (authState: {
  canWrite: boolean;
  isOwner: boolean;
  user: any;
}) => {
        ...
        h(
          ...
          [
            h(
              ...
              {
                class:
                  'bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden max-h-[90vh] flex flex-col',
              },
              [
                // Header
                h(
                  ...
                  [
                    ...
                    h(
                      ...
                      {
                        class:
                          'p-1.5 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 transition-colors',
                        onClick: () => emit('close'),
                      },
                      [
                        h(
                    ...
                    : h('div', {}, [
                        ...
                        !authState.canWrite &&
                          h(
                            ...
                            {
                              class:
                                'mb-4 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700',
                            },
                            [
                              h(
                                'div',
                              ...
                              h(
                                'p',
                                { class: 'text-xs text-amber-600 dark:text-amber-400 mt-1 ml-7' },
                                'You can view existing embeds but cannot create new ones.'
                              ),
                            ]
                          ),
                        ...
                        authState.canWrite &&
                          h('div', { class: 'mb-6' }, [
                            h(
                              ...
                              {
                                class:
                                  'w-full px-4 py-3 bg-cyan-600 text-white font-medium rounded-lg hover:bg-cyan-500 transition-colors flex items-center justify-center gap-2',
                              },
                              [
                                h(
                                  'svg',
                          ...
                          ? h(
                              ...
                              [
                                ...
                                h(
                                  'p',
                                  { class: 'text-xs mt-1' },
                                  'Click "Create New Embed" to get started'
                                ),
                              ]
                            )
                          : h(
                              ...
                              props.embeds.map((embed: any) =>
                                h(
                                  'div',
                                  {
                                    key: embed.id,
                                    class:
                                      'p-3 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-cyan-400 dark:hover:border-cyan-600 cursor-pointer transition-colors bg-white dark:bg-slate-800/50',
                                  },
                                  [
                                    h('div', { class: 'flex items-center justify-between' }, [
                                      h('div', {}, [
                                        ...
                                        h(
                                          ...
                                          {
                                            class:
                                              'text-xs text-slate-500 dark:text-slate-400 mt-0.5 flex items-center gap-2',
                                          },
                                          [
                                            embed.sensitiveMode &&
                                              h(
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Modal for creating and managing shareable embed links for the network map. Supports sensitive mode (hiding IPs) and owner attribution.',
      },
    },
  },
  argTypes: {
...
export const ReadOnlyWithEmbeds: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Read-only users can view existing embeds but cannot create new ones. The "Create New Embed" button is hidden.',
      },
    },
  },
};
...
export const WriteAccess: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Users with write access can create new embeds. The "Create New Embed" button is visible.',
      },
    },
  },
};
...
export const EmptyWithWriteAccess: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Empty state for users with write access. Shows the create button and empty state message.',
      },
    },
  },
};
