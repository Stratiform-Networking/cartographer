        ...
        h('div', { class: 'relative' }, [
          ...
          h(
            'button',
            {
              ...
              class:
                'flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors',
            },
            [
              // Avatar
              h(
                ...
                {
                  class:
                    'w-7 h-7 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-white text-xs font-semibold shadow-sm',
                },
                userInitial
              ),
              h('div', { class: 'flex flex-col items-start' }, [
                h(
                  ...
                  {
                    class:
                      'text-sm font-medium text-slate-700 dark:text-slate-200 max-w-24 truncate leading-tight',
                  },
                  displayName
                ),
                h(
                  'span',
                  { class: `text-[10px] leading-tight font-medium ${roleBadgeClass}` },
                  roleLabel
                ),
              ]),
              // Dropdown Arrow
          ...
          isOpen.value &&
            h(
              ...
              {
                class:
                  'absolute right-0 mt-2 w-56 rounded-xl shadow-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 overflow-hidden z-50',
              },
              [
                // User Info Header
                h(
                  ...
                  {
                    class:
                      'px-4 py-3 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700',
                  },
                  [
                    h('div', { class: 'flex items-center gap-3' }, [
                      h(
                        ...
                        {
                          class:
                            'w-10 h-10 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-white text-base font-semibold shadow-sm',
                        },
                        userInitial
                      ),
                  ...
                  isOwner &&
                    h(
                      'button',
                      {
                        ...
                        class:
                          'w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors',
                      },
                      [
                        h(
                          'div',
                          {
                            class:
                              'w-8 h-8 rounded-lg bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center',
                          },
                          [
                            h(
                              'svg',
                  ...
                  h(
                    ...
                    [
                      h(
                        ...
                        {
                          class:
                            'w-8 h-8 rounded-lg bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center',
                        },
                        [
                          h(
                            'svg',
                  ...
                  h(
                    ...
                    [
                      h(
                        ...
                        {
                          class:
                            'w-8 h-8 rounded-lg bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center',
                        },
                        [
                          h(
                            'svg',
                  ...
                  h(
                    ...
                    [
                      h(
                        ...
                        {
                          class:
                            'w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center',
                        },
                        [
                          h(
                            'svg',
                ...
                h('div', { class: 'border-t border-slate-200 dark:border-slate-700 p-2' }, [
                  h(
                    'button',
                    {
                      ...
                      class:
                        'w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors',
                    },
                    [
                      h(
                        'svg',
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'User menu dropdown with profile info, settings access, and logout functionality. Shows different options based on user role.',
      },
    },
  },
  argTypes: {
...
export const OwnerClosed: Story = {
  render: (args) => ({
    ...
    template:
      '<MockedUserMenu @logout="args.onLogout" @manage-users="args.onManageUsers" @notifications="args.onNotifications" @updates="args.onUpdates" />',
  }),
  args: {
    onLogout: fn(),
    onManageUsers: fn(),
