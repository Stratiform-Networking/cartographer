      ...
      return () =>
        show.value
          ? h(
              ...
              {
                class: [
                  'relative z-50 flex items-center justify-center gap-3 px-4 py-2 text-sm font-medium cursor-pointer transition-colors duration-200',
                  bannerClasses.value,
                ],
              },
              [
                ...
                h('span', [
                  ...
                  h(
                    'span',
                    { class: 'hidden sm:inline opacity-75' },
                    `(you're on v${config.currentVersion})`
                  ),
                ]),
                ...
                h(
                  ...
                  {
                    class:
                      'hidden md:inline-flex items-center gap-1 opacity-75 hover:opacity-100 transition-opacity',
                  },
                  [
                ...
                h(
                  'button',
                  {
                    ...
                    class:
                      'absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-lg transition-colors hover:bg-black/10 dark:hover:bg-white/10',
                ...
                h(
                  'button',
                  {
                    ...
                    class:
                      'absolute right-10 top-1/2 -translate-y-1/2 p-1.5 rounded-lg transition-colors hover:bg-black/10 dark:hover:bg-white/10',
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Notification banner displayed at the top of the page when a new version is available. Color-coded by update type: rose for major, cyan for minor, emerald for patch.',
      },
    },
  },
  decorators: [
...
export const MajorUpdate: Story = {
  render: () => ({
    components: {
      VersionBanner: createMockedVersionBanner({
...
export const AllTypes: Story = {
  render: () => ({
    components: {
      MajorBanner: createMockedVersionBanner({
        currentVersion: '1.0.0',
        latestVersion: '2.0.0',
        updateType: 'major',
      }),
      MinorBanner: createMockedVersionBanner({
        currentVersion: '1.2.0',
        latestVersion: '1.3.0',
        updateType: 'minor',
      }),
      PatchBanner: createMockedVersionBanner({
        currentVersion: '1.2.3',
        latestVersion: '1.2.4',
        updateType: 'patch',
      }),
