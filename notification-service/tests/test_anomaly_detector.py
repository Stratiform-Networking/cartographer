...
from app.models import AnomalyType, NotificationPriority, NotificationType
...
class TestLatencyStats:
    ...
    def test_from_dict(self):
        ...
        stats = LatencyStats.from_dict(
            {"count": 5, "mean": 25.0, "m2": 100.0, "min_value": 10.0, "max_value": 40.0}
        )
...
class TestDeviceStats:
    ...
    def test_get_expected_state(self):
        ...
        state, confidence = stats.get_expected_state_for_time(datetime(2024, 1, 1, 10, 0))
...
class TestAnomalyDetector:
    ...
    def test_train_new_device(self, anomaly_detector_instance):
        ...
        with patch.object(anomaly_detector_instance, "_save_state"):
            anomaly_detector_instance.train(
                "192.168.1.100", success=True, latency_ms=25.0, device_name="Test Device"
            )
    ...
    def test_train_updates_stats(self, anomaly_detector_instance):
        ...
        with patch.object(anomaly_detector_instance, "_save_state"):
            for _ in range(10):
                anomaly_detector_instance.train("192.168.1.100", success=True, latency_ms=25.0)
    ...
    def test_detect_anomaly_insufficient_data(self, anomaly_detector_instance):
        ...
        result = anomaly_detector_instance.detect_anomaly("192.168.1.100", success=False)
    ...
    def test_detect_anomaly_unexpected_offline(
        self, anomaly_detector_instance, sample_device_stats
    ):
    ...
    def test_detect_anomaly_latency_spike(self, anomaly_detector_instance, sample_device_stats):
        ...
        result = anomaly_detector_instance.detect_anomaly(
            "192.168.1.100", success=True, latency_ms=100.0  # Way above normal
        )
    ...
    def test_detect_anomaly_packet_loss(self, anomaly_detector_instance, sample_device_stats):
        ...
        result = anomaly_detector_instance.detect_anomaly(
            "192.168.1.100", success=True, packet_loss=0.25  # 25% packet loss
        )
    ...
    def test_create_network_event_device_offline(self, anomaly_detector_instance):
        ...
        with patch.object(anomaly_detector_instance, "_save_state"):
            event = anomaly_detector_instance.create_network_event(
                "192.168.1.100", success=False, device_name="Test Device", previous_state="online"
            )
    ...
    def test_create_network_event_device_online(self, anomaly_detector_instance):
        ...
        with patch.object(anomaly_detector_instance, "_save_state"):
            for _ in range(5):
                anomaly_detector_instance.train(
                    "192.168.1.100", success=False, device_name="Test Device"
                )

        # Now device comes online
        with patch.object(anomaly_detector_instance, "_save_state"):
            event = anomaly_detector_instance.create_network_event(
                "192.168.1.100", success=True, device_name="Test Device", previous_state="offline"
            )
    ...
    def test_get_model_status_with_current_devices(
        self, anomaly_detector_instance, sample_device_stats
    ):
