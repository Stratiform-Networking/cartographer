...
class TestNetworkAnomalyDetectorManager:
    ...
    def test_save_all(self):
        ...
        with patch.object(manager._detectors["network1"], 'save') as mock1, \
...
class TestDeviceStats:
    ...
    def test_update_check_success(self):
        ...
        stats.update_check(success=True, latency_ms=50.0, packet_loss=0.0, check_time=datetime.utcnow())
    ...
    def test_update_check_failure(self):
        ...
        stats.update_check(success=False, latency_ms=None, packet_loss=None, check_time=datetime.utcnow())
